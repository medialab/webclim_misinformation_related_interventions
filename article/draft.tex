...
In this article, we survey a number of common policies against misinformation used by Facebook, Twitter and YouTube, that we seperated in three broad categories: temporary or permanent suspension of users, reducing the visibility of some content, introducing flags and notices. Finally, we discuss how an increased effort of transparency regarding specific content can help the community of researchers study and assess the impact of platforms' policies regarding misinformation.

\smallskip 

We compile in Appendix \ref{links} in table \ref{summary}, a list of links that redirect to the policies, regulations and transparency centers of Facebook, Twitter and YouTube that we discuss throughout the article.
...
\begin{figure}[h]
	...
	%\end{multicols}
	\caption{Examples of YouTube information panels displayed under Youtube videos respectively about: \href{https://www.youtube.com/watch?v=OwqIy8Ikv-c}{Climate change}, \href{https://www.youtube.com/watch?v=9sW0OmzcmL0}{COVID-19 Vaccine}, \href{https://www.youtube.com/watch?v=usyQgPU-VrI}{COVID-19} and \href{https://www.youtube.com/watch?v=8PAwc8nlE\_Q}{US elections}. }
	\label{fig9}
\end{figure}
...
\begin{figure}[h]
	...
	%\end{multicols}
	%\begin{multicols}{1}
		\includegraphics[scale=0.2]{./img/youtube_panels/news_without_banner_2.png} 
	%\end{multicols}
	%\begin{multicols}{1}
	...
	%\end{multicols}
	\caption{Screenshots taken on July 21, 2021. The screenshots show two duplicates of the same YouTube video uploaded under different titles. Left panel: contains no information panel. Right panel: contains an information panel. }
	\label{duplicates_yt}
\end{figure}
