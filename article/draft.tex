...
%'Big Tech is censoring me': Using social media data to verify the platforms' regulation policies regarding ``misinformation''
...
No information regarding the flags can be found on Buzzsumo or CrowdTangle, the two APIs we use to access Facebook data. To verify Facebook’s flag policy, only two options are possible: manually or by scraping Facebook.

To better understand the banners implemented by Facebook, we searched for all the Facebook posts having shared a link rated as ‘False’ by Science Feedback with the `search` endpoint in minet. \footnote{ link: \href{https://beforeitsnews.com/eu/2021/04/stay-away-from-the-vaxxed-it-is-official-from-pfizers-own-documents-2671454.html}{https://beforeitsnews.com/eu/2021/04/stay-away-from-the-vaxxed-it-is-official-from-pfizers-own-documents-2671454.html}{https://beforeitsnews.com/eu/2021/04/stay-away-from-the-vaxxed-it-is-official-from-pfizers-own-documents-2671454.html} and its fact-check: \href{https://healthfeedback.org/claimreview/insufficient-evidence-to-claim-covid-19-vaccines-cause-menstrual-irregularities-in-vaccinated-women-vaccinated-people-arent-making-unvaccinated-people-ill/}{https://healthfeedback.org/claimreview/insufficient-evidence-to-claim-covid-19-vaccines-cause-menstrual-irregularities-in-vaccinated-women-vaccinated-people-arent-making-unvaccinated-people-ill/}). The command can be found here: \href{https://github.com/medialab/truth-and-trust-online-2021/blob/master/code/collect\_facebook\_crowdtangle\_false\_link.sh}{https://github.com/medialab/truth-and-trust-online-2021/blob/master/code/collect\_facebook\_crowdtangle\_false\_link.sh}.} We collected 20 Facebook posts and we manually opened them to verify whether they were flagged with an information banner, a fact-check flag, both or none (2 posts were unavailable so only 18 were categorized). As Science Feedback has sent a False fact-check for this link to Facebook, we would expect all these posts to contain a fact-check flag, but we had no expectations for the information banner.
...
We observed that 11 posts out of 18 had a ‘False information’ flag. We observed that the posts with the ‘False information’ flag were also the ones with a preview of the link (i.e. the banner with an image of the link that we can click on). As the ‘False information’ flag is applied on the preview of the link, and not on the link itself, a user could share a link without the ‘False information’ banner as in the first example of Figure  \ref{fb_flags}.

We also observed that most of the posts (14 out of 18) had an information banner saying ‘Visit the COVID-19 Information Centre for vaccine resources’ (see the first two examples of Figure \ref{fb_flags}). We could not identify why the banner was applied on some posts and not on others (we saw no clear difference in the post message for example).
...
\hline
Category       & \begin{tabular}[c]{@{}c@{}}Number of Youtube \\ videos with \\ an information panel\end{tabular} & \begin{tabular}[c]{@{}c@{}}Number of Youtube \\ videos without \\ an information panel\end{tabular}    \\ \hline
