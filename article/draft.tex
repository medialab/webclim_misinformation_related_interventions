...
Finally, suspending a Twitter account is an intervention which aims at penalizing users, in order to make them respect the Twitter rules. In the case of Twitter accounts linked to domain names, the activity of the account usually consists in spreading on social media published articles on the website. Panel $(b)$ points towards the limitations of suspending the Twitter account $@LifeSite$, because the content created by the domain lifesitenews.com was still being actively shared by other Twitter users. 
...
\begin{figure}[h]
\centering
		\includegraphics[scale=0.27]{../figure/globalresearch_domain.jpg} 
		\includegraphics[scale=0.27]{../figure/globalresearch_domain_engagement.jpg}
