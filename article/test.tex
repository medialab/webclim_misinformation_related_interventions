...
%public content\\  insights tool \\ owned and operated by \\ Facebook. \\ \href{https://buzzsumo.com}{Buzzsumo}: commercial content \\ database
...
&  \begin{tabular}[c]{@{}l@{}} Application Programming \\ Interface (API)  \end{tabular}                                                                                                                                                                                                                                                                                                                                                                                                                                            &    \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}} Web \\ Scraping \end{tabular}}                                                                                                                                                                 \\ \hline
 \includegraphics[scale=0.05]{./img/fb_logo.png} & \begin{tabular}[c]{@{}l@{}}\href{https://www.crowdtangle.com}{CrowdTangle}  \\ \href{https://buzzsumo.com}{Buzzsumo} \end{tabular}                                                                                                                                                                                                               &      \multicolumn{1}{l|}{}    
\\ \hline
...
\begin{figure}
	\centering
	\begin{multicols}{1}
		\includegraphics[scale=0.29]{./img/oann/fig1_oann.png}
	\end{multicols}
	\begin{multicols}{1}
		\includegraphics[scale=0.3]{./img/oann/fig2_oann.png} 
	\end{multicols}
...
\begin{figure}
	\centering
	\begin{multicols}{1}
		\includegraphics[scale=0.32]{./img/oann/fig3_oann.png}
	\end{multicols}
	
	\begin{multicols}{1}
		\includegraphics[scale=0.35]{./img/tony/fig3_tony.png}
	\end{multicols}
...
\centering
	...
	\end{multicols}
	\begin{multicols}{1}
		\includegraphics[scale=0.33]{./img/globalresearch/engagement_sum_rolling_1_globalresearch.ca.jpg}
	\end{multicols}
...
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}  Rules \\ enforcement \end{tabular}}         & \includegraphics[scale=0.05]{./img/fb_logo.png}  & \href{https://transparency.fb.com/data/community-standards-enforcement/}{transparency.fb.com/data/community-standards-enforcement/}                 \\ \cline{2-3} 
...
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}  Transparency \\ center \end{tabular}}       & \includegraphics[scale=0.05]{./img/fb_logo.png} & https://transparency.fb.com/data/                                                  \\ \cline{2-3} 
...
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}  Policy regarding \\  Covid-19 \end{tabular}} & \includegraphics[scale=0.05]{./img/fb_logo.png} & https://www.facebook.com/help/230764881494641/                                     \\ \cline{2-3} 
...
\multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}  Fact-checking \\ policy \end{tabular}} & \includegraphics[scale=0.05]{./img/fb_logo.png} & \href{https://www.facebook.com/journalismproject/programs/third-party-fact-checking/how-it-works}{facebook.com/journalismproject/programs/third-party-fact-checking/how-it-works}                                    \\ \cline{2-3} 
